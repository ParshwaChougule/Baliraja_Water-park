  ...
  return (
    <div>
      ...
      <section style={{ 
        ...
        backgroundImage: 'linear-gradient(rgba(0,0,0,0.7), rgba(0,0,0,0.7)), url("https://images.unsplash.com/photo-1594736797933-d0401ba2fe65?ixlib=rb-4.0.3&auto=format&fit=crop&w=1200&q=80")',
        ...
        <div style={{ maxWidth: '900px', margin: '0 auto', padding: '0 20px', textAlign: 'center' }}>
          ...
          <nav style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <span style={{ color: '#4FC3F7', fontSize: '16px' }}>Attractions</span>
          </nav>
        </div>
      </section>
      ...
      <div className="container-fluid attractions py-5" style={{marginTop: '100px'}}>
        <div className="container attractions-section py-5">
          <div className="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style={{maxWidth: '800px'}}>
            ...
            <h1 className="display-5 text-white mb-4">Explore Baliraja Agro Tourism Park Attractions</h1>
